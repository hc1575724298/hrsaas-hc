 ...
 * @Date: 2022-08-12 11:20:06
 * @LastEditors: sj
 * @LastEditTime: 2022-08-12 15:59:01
-->
<template>
  <el-dialog
  title="新增员工"
  ...
  >
      ...
      <el-form-item label="部门" prop="departmentName">
        ...
        <el-select v-model="formData.departmentName" @focus="getDepts" ref="depSelect">
...
import {addEmployeedInfoApi} from '@/api/employees'
...
export default {
 ...
 methods:{
  ...
  treeNodeClick(row){
    ...
    this.$refs.depSelect.blur()
  },
  //点击确定
  onSave(){
    this.$refs.form.validate(async(valid)=>{
      if(!valid) return
      await addEmployeedInfoApi(this.formData)
